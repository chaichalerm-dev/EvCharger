...
- Demo Role is not authentication or backend authorization.
- Local photo preview is not durable upload.
- Financial simulation excludes many real costs, taxes, tariffs, utilization curves, financing, degradation, and revenue streams.
- Thai translation demonstrates architecture and primary dashboard copy; complete professional localization requires a translation pass.
