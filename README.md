...
- Thailand-constrained MapLibre map, place search, click-to-select, 1/3/5/10 km analysis radius, category-specific Lucide map symbols, compact clustering, a collapsible map legend, global Mapterhorn 3D terrain, and OpenFreeMap building extrusions where OpenStreetMap footprints are available.
